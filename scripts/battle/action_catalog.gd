...
const ACTIONS := {
	...
	"act_shatter": {"title": "还刃·重斩", "type": "PLAYER", "entry_pose": "high", "exit_pose": "low", "movement": "lunge", "startup": 0.22, "impact_time": 0.36, "recovery": 0.46, "cancel_window": 0.12, "impact_level": "HEAVY", "combo_tags": ["heavy"], "parry_cancel": "NONE"},
	"act_shoulian": {"title": "收殓·合葬", "type": "PLAYER", "entry_pose": "right", "exit_pose": "left", "movement": "lunge", "startup": 0.20, "impact_time": 0.34, "recovery": 0.44, "cancel_window": 0.12, "impact_level": "HEAVY", "combo_tags": ["finisher"], "parry_cancel": "NONE"},
	"act_yuangui": {"title": "怨归·刺击", "type": "PLAYER", "entry_pose": "low", "exit_pose": "thrust", "movement": "lunge", "startup": 0.18, "impact_time": 0.30, "recovery": 0.40, "cancel_window": 0.14, "impact_level": "HEAVY", "combo_tags": ["finisher"], "parry_cancel": "NONE"},
	"act_tianping": {"title": "天平·倒悬", "type": "PLAYER", "entry_pose": "high", "exit_pose": "thrust", "movement": "leap", "startup": 0.30, "impact_time": 0.48, "recovery": 0.60, "cancel_window": 0.0, "impact_level": "HEAVY", "combo_tags": ["finisher"], "parry_cancel": "NONE", "on_hit": "ARMOR"},
	...
	"act_jinshen": {"title": "金身·护桩", "type": "RULE", "entry_pose": "guard", "exit_pose": "guard", "movement": "none", "startup": 0.10, "impact_time": 0.16, "recovery": 0.24, "cancel_window": 0.22, "impact_level": "LIGHT", "combo_tags": ["setup"], "on_hit": "ARMOR"},
