...
const ACTIONS := {
	...
	"act_zhuying": {"title": "逐影·突进", "type": "PLAYER", "entry_pose": "right", "exit_pose": "left", "movement": "dash", "startup": 0.08, "impact_time": 0.20, "recovery": 0.24, "cancel_window": 0.18, "impact_level": "LIGHT", "combo_tags": ["chase", "chain"]},
	...
	"act_jiedao": {"title": "借刀·截招", "type": "ENEMY_TIMELINE", "entry_pose": "guard", "exit_pose": "neutral", "movement": "step", "startup": 0.06, "impact_time": 0.16, "recovery": 0.28, "cancel_window": 0.22, "impact_level": "INTERRUPT", "combo_tags": ["timeline", "counter"]},
	...
	"act_yandeng": {"title": "延灯·拖拍", "type": "ENEMY_TIMELINE", "entry_pose": "spell", "exit_pose": "spell", "movement": "retreat", "startup": 0.12, "impact_time": 0.20, "recovery": 0.26, "cancel_window": 0.20, "impact_level": "LIGHT", "combo_tags": ["timeline"]},
	"act_jiezou": {"title": "劫奏·断拍", "type": "ENEMY_TIMELINE", "entry_pose": "thrust", "exit_pose": "left", "movement": "step", "startup": 0.10, "impact_time": 0.20, "recovery": 0.28, "cancel_window": 0.20, "impact_level": "LIGHT", "combo_tags": ["timeline"]},
